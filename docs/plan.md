...
13. Страница логина администратора `/pekarnya-control/login`
14. Layout админ-панели: Sidebar (20% ширины) + область контента
15. Админ: Dashboard (сводка за день/неделю, график продаж, топ товаров, новые заказы, уведомления) (доведён до Prisma в хвосте пункта 35)
...
18. Админ: раздел Клиенты (база клиентов, история покупок) (доведён до Prisma в хвосте пункта 35)
19. Админ: раздел Отзывы (модерация, ответ от магазина)
20. Админ: Управление страницами (О нас/Контакты/Доставка, SEO title/description, баннеры/слайдер на главной) (доведён до Prisma в хвосте пункта 35; админка сохраняет `SitePage`/`Banner` в БД, но вывод их на публичную витрину — публичные страницы, слайдер баннеров на главной — в плане отдельным пунктом не заложен и не сделан)
21. Админ: Настройки (пользователи админки и роли, настройки уведомлений) (доведён до Prisma в хвосте пункта 35)
