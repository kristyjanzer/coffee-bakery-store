...
// попадают и проверяют сессию/роль сами (requireAdminSession в lib/auth/auth.ts).
//
...
// lib/auth/auth.ts). Тонкие ограничения по роли (ORDER_MANAGER не создаёт товары и т.п.)
