...
Dark olive (#1d0b0d) background, full-bleed, ~80px tall. Two-column nav link groups (Logo on left; Home, Menu, Reviews, Contacts on right) set in VenusCom 16px weight 400 letter-spacing 0.04em uppercase in Warm Cream (#fcf9f0). Vertical separators between nav items are implied by spacing rather than drawn.
...
**Role:** Menu item tile in the cream section's three-up grid. Menu item display — one card per food item in the browsing grid.
