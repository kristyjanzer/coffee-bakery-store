...
import type { AdminRole, AdminUserRecord } from "@/lib/auth/adminRoles";
...
// Server-код и тесты по-прежнему берут их из "@/lib/server/settings" через ре-экспорт.
export { ADMIN_ROLES, ADMIN_ROLE_LABELS } from "@/lib/auth/adminRoles";
...
// форм — через lib/api-client/settingsAdminApi.ts → /api/admin-users. Пароль (passwordHash)
