...
// путать с lib/shared/reviews.ts (мок-данные слайдера на главной и раздела админки "Отзывы",
...
//
// Prisma импортируется сюда, а в lib/shared/reviews.ts — нет: оттуда тянут клиентские
...
// null — отзыв с таким id не найден (аналог updateOrderStatus в lib/server/orderAdmin.ts).
