...
// Не путать с lib/server/productCatalog.ts — там публичные запросы для GET /api/products;
...
// ProductForm (lib/api-client/productAdminApi.ts), а не отсюда — HTTP-граница + проверка
