...
import type { MenuCategory, MenuProduct } from "@/lib/shared/menu";

// Витрина (главная + страница товара) читает каталог напрямую из Prisma
// (docs/plan.md, пункт 35) — раньше здесь был мок из menu.json (lib/shared/menu.ts,
...
//
// lib/shared/menu.ts остаётся — его getProductById() нужен клиентскому CartWidget
