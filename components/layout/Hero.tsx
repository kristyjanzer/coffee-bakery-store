  ...
  return (
    <section className="relative flex min-h-[calc(100vh-80px)] items-center overflow-hidden bg-black-olive px-6 py-16">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1200px]">
        <h1 className="font-venuscom text-heading-lg font-normal uppercase leading-none text-lemon-zest md:text-display-xl">
          <span className="block">Утро</span>
          <span className="mt-3 block">Начинается здесь</span>
        </h1>
